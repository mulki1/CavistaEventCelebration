...
namespace CavistaEventCelebration.Api.Services.Interface
{
    ...
    {
        Task<SignInResponse> AdminCreateUserAsync(AdminUserSignUpModel model);
        ...
        Task<ChangeUserStatusResponse> ChangeUserStatusAsync(string userId, UserStatus status);
